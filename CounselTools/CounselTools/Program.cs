...
namespace CounselTools
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            catalog1.Add(new RibbonFeature("K12.CounselTools.ExportNotInputABCardComplete", "綜合紀錄表輸入進度表"));

            RibbonBarItem rbRptItemABNew = MotherForm.RibbonBarItems["學生", "輔導"];
            rbRptItemABNew["報表"]["綜合紀錄表輸入進度表"].Enable = UserAcl.Current["K12.CounselTools.ExportNotInputABCardComplete"].Executable;
            rbRptItemABNew["報表"]["綜合紀錄表輸入進度表"].Click += delegate
            {
