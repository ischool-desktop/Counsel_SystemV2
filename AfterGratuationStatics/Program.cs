...
namespace AfterGratuationStatics_whsh
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            rbRptItem1["報表"]["畢業後進路公務統計報表 "]["0.下載畢業生進路調查樣板"].Enable = true;
            ...
            rbRptItem1["報表"]["畢業後進路公務統計報表 "]["1.匯入畢業生進路調查樣板"].Enable = true;
            ...
            rbRptItem1["報表"]["畢業後進路公務統計報表 "]["2.匯入畢業生進路調查公務統計報表(學校分類)"].Enable = true;
            ...
            rbRptItem1["報表"]["畢業後進路公務統計報表 "]["3.匯入畢業生進路調查公務統計報表(學生系統分類)"].Enable = true;
